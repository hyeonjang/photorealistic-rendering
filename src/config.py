...
CONFIGS = {
    ...
    'cbox-tex-256-adam' : {
        'name' : 'cbox-tex-256-adam',
        'opt_scene' : join(SCENE_DIR, 'cbox-tex-256/cbox_opt.xml'),
        'ref_scene' : join(SCENE_DIR, 'cbox-tex-256/cbox_ref.xml'),
        'ref_texture' : join(SCENE_DIR, 'cbox-tex-256/hokusai-wave.jpg'),
        'ref_envmap' : None,
        'ref_image' : join(OUTPUT_DIR, 'cbox-tex/cbox.exr'),
        'max_iterations' : 10,
        'learning_rate' : 0.05,
